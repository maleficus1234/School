...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements P2PWebService.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/P2PWebService/services/Service";
    ...
    public P2PWebService.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            P2PWebService.ServiceSoapBindingStub _stub = new P2PWebService.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (P2PWebService.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                P2PWebService.ServiceSoapBindingStub _stub = new P2PWebService.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://P2PWebService", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://P2PWebService", "Service"));
        }
