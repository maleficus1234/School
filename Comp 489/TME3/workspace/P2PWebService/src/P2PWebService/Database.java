...
public class Database 
{
	...
	public static void updateAddress(String username, String address, int port)
	{
		try
		{
	...
	public static boolean isShared(String username, String filename)
	{
		try
		{
			Connection con = getConnection();
	...
	public static void share(String username, String filename)
	{
		try
		{
	...
	public static String [] getShared(String username)
	{
	...
	public static void stopShare(String username, String filename)
	{
		try
		{
	...
	public static String [] findFile(String username, String filename)
	{
